(function() {
  var Link, PropTypes, React, singleInstance, utils,
  ...
  module.exports = Link = (function(superClass) {
    ...
    Link.prototype.onClick = function(event) {
      ...
      return singleInstance.getRouter().go(this.props.to);
    };
    ...
    Link.prototype.render = function() {
      ...
      if (typeof this.props.to === 'object') {
        route = utils.findRouteByNameInRoutes(this.props.to.name, singleInstance.getRouter().routes);
