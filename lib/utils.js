(function() {
  ...
  module.exports = utils = {
    ...
    fetchResolveData: function(route, params, reusableResolveData, history) {
      ...
      taskInformation = [];
      tasks = [!route.component ? typeof route.loadComponent === "function" ? route.loadComponent() : void 0 : null];
      ...
      return Promise.all(tasks).then(function(arg) {
        var component, index, information, j, len1, name1, responses, result;
        component = arg[0], responses = 2 <= arg.length ? slice.call(arg, 1) : [];
        if (component) {
