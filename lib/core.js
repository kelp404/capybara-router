(function() {
  ...
  core = {
    ...
    onHistoryChange: function(location, action) {
      ...
      return core.promise = core.fetchResolveData(nextRoute, params, (ref = core.views[changeViewIndex]) != null ? ref.name : void 0, core.lastResolveData).then(function(resolveData) {
        var base, props;
