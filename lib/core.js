(function() {
  ...
  core = {
    ...
    generateRoute: function(args, routes) {
      var hrefTemplate, i, j, len, len1, match, parentRoute, ref, ref1, ref2, ref3, uriParamPattern, uriPattern, uriQueryString;
      if (args == null) {
        args = {};
      }
      ...
      ref1 = (ref = args.uri.match(/\{[\w]+:(?:(?!(\/|\?\w+)).)+/g)) != null ? ref : [];
      for (i = 0, len = ref1.length; i < len; i++) {
        uriParamPattern = ref1[i];
      ...
      ref3 = (ref2 = args.uri.match(/\?[\w-]+/g)) != null ? ref2 : [];
      for (j = 0, len1 = ref3.length; j < len1; j++) {
        uriQueryString = ref3[j];
