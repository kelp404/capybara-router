(function() {
  ...
  core = {
    ...
    setup: function(args) {
      ...
      return core.promise = core.fetchResolveData(currentRoute, params, '', core.lastResolveData, core.history).then(function(resolveData) {
    ...
    onHistoryChange: function(location, action) {
      ...
      return core.promise = core.fetchResolveData(nextRoute, params, (ref = core.views[changeViewIndex]) != null ? ref.name : void 0, core.lastResolveData, core.history).then(function(resolveData) {
        var base, props;
    ...
    reload: function() {
      ...
      return core.promise = core.fetchResolveData(route, params, '', {}, core.history).then(function(resolveData) {
        ...
        return Promise.all([historyActions.RELOAD, route, params, route, params, props]);
      })["catch"](function(error) {
        if (!error) {
          return;
        }
    ...
    fetchResolveData: function(route, params, reloadFrom, lastResolveData, history) {
      ...
      return Promise.all(tasks).then(function(responses) {
        var index, information, j, len1, name, result;
        ...
        for (index = j = 0, len1 = taskInformation.length; j < len1; index = ++j) {
          ...
          if (result[name = information.routeName] == null) {
            result[name] = {};
          }
